...
public class BeerClientImpl implements BeerClient {
    ...
    public Page<BeerDTO> listBeers(String beerName, BeerStyle beerStyle,
        ...
        if (showInventory != null) {
            uriComponentsBuilder.queryParam("showInventory", beerName);
        }
        if (pageNumber != null) {
            uriComponentsBuilder.queryParam("pageNumber", beerName);
        }
        if (pageSize != null) {
            uriComponentsBuilder.queryParam("pageSize", beerName);
        }
